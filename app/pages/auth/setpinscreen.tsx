  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: themeStyles.background }]}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={[styles.title, { color: themeStyles.buttonText, fontWeight: 'bold' }]}>{props.title}</Text>
        ...
        <View style={styles.pinInputContainer}>
          {Array.from({ length: 4 }).map((_, index) => (
            <View
              ...
              style={[
                styles.pinDot,
                { backgroundColor: pin.length > index ? themeStyles.pinDotFilled : themeStyles.passwordPins },
              ]}
            />
          ))}
        </View>
        ...
        <View style={styles.numberPad}>
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((digit) => (
            <TouchableOpacity
              key={digit}
              style={[styles.numberButton, { backgroundColor: themeStyles.buttonBackground }]}
